...
from drf_spectacular_extended.plumbing import OpenApiGeneratorExtension
...
class OpenApiFilterExtension(OpenApiGeneratorExtension['OpenApiFilterExtension']):
    ...
    Using ``drf_spectacular_extended.plumbing.build_parameter_type`` is recommended to generate
