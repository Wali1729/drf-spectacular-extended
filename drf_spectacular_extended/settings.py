...
SPECTACULAR_DEFAULTS: Dict[str, Any] = {
    ...
    'DEFAULT_GENERATOR_CLASS': 'drf_spectacular_extended.generators.SchemaGenerator',
    ...
    'POSTPROCESSING_HOOKS': [
        'drf_spectacular_extended.hooks.postprocess_schema_enums'
    ],
    ...
    # Example: 'drf_spectacular_extended.hooks.preprocess_exclude_path_format'
    'PREPROCESSING_HOOKS': [],
    ...
    'GET_LIB_DOC_EXCLUDES': 'drf_spectacular_extended.plumbing.get_lib_doc_excludes',
    ...
    'GET_MOCK_REQUEST': 'drf_spectacular_extended.plumbing.build_mock_request',
    ...
    # 'drf_spectacular_extended.contrib.djangorestframework_camel_case.camelize_serializer_fields'
