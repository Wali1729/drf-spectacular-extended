...
from drf_spectacular_extended.settings import patched_settings, spectacular_settings
...
def _get_sidecar_url(filepath):
    return static(f'drf_spectacular_extended_sidecar/{filepath}')
...
class SpectacularSwaggerView(APIView):
    ...
    template_name: str = 'drf_spectacular_extended/swagger_ui.html'
    template_name_js: str = 'drf_spectacular_extended/swagger_ui.js'
...
class SpectacularRedocView(APIView):
    ...
    url_name: str = 'schema'
    url: Optional[str] = None
    template_name: str = 'drf_spectacular_extended/redoc.html'
