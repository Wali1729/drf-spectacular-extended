from drf_spectacular_extended.drainage import error, warn
from drf_spectacular_extended.extensions import OpenApiSerializerExtension
from drf_spectacular_extended.plumbing import force_instance, is_list_serializer, is_serializer


class PolymorphicProxySerializerExtension(OpenApiSerializerExtension):
    target_class = 'drf_spectacular_extended.utils.PolymorphicProxySerializer'
    priority = -1
